...
public class BrokerApiTest {
  ...
  public void shouldRegisterConsumerPerTopic() {
    ...
    ArgumentCaptor<SourceAwareEventWrapper> secondArgCaptor = ArgumentCaptor.forClass(SourceAwareEventWrapper.class);
  ...
  private void compareWithExpectedEvent(
    ...
    assertThat(eventCaptor.getValue().getHeader().toString()).isEqualTo(expectedEvent.getHeader().toString());
